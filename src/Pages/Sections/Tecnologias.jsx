import { SiReact,SiHtml5, SiJavascript, SiCss3, SiMysql, SiPython, SiTypescript } from "react-icons/si";
 ...
 export const Technologias = () => {
   return (
     <section className="w-full h-[73vh] flex flex-col sm:flex-row xs:h-auto xs:flex-col items-center justify-around gap-12 px-4 py-10 max-w-screen-lg mx-auto">
       <div className="flex flex-col items-center w-full">
           <h2 className="text-3xl mb-4 font-bold text-primary"> Tecnologías </h2>
